// Date : 1970.1.1  자정(UTC)부터 초를 누적하여 관리
{
  ...
  console.log(today); //2023-02-08T02:08:11.945Z
  console.log(today.getDate()); //8 ,일 
  console.log(today.getFullYear()); //2023, 년도
  console.log(today.getMonth()); //1 , 월 ( 0->1월, 1->2월, 2->3월,...11->12월)
  console.log(today.getDay()); //3, 요일 (0->일요일, 1->월, 2->화,.. 6->토)
  console.log(today.getHours()); //11 , 시간
  console.log(today.getMinutes()); //9 , 분
  console.log(today.getSeconds()); //22, 초
  console.log(today.getMilliseconds()); //730 , 1/1000초
  console.log(today.toLocaleString()); //2023. 2. 8. 오전 11:11:17
  console.log(today.toLocaleDateString()); //2023. 2. 8.
  console.log(today.toLocaleTimeString()); //오전 11:11:34
  console.log(Date.now()); // 1675822971728 1970년 1월 1일 00:00:00 UTC로부터 지난 시간을 밀리초 단위의 숫자 값으로 반환
}
{
  const today = new Date();
  console.log(today);
